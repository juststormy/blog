...
var precacheConfig = [
    ...
    [
        "",
        "UuTZ0WSzaxwQ34M6mh3zvw"
    ],
    [
        "\/",
        "L76cF0kxXac8h8rOMo8Mw"
    ],
    [
        "index.html",
        "ZEDXQnsHeaOIsoNNmqGWkw"
    ],
    [
        "manifest.json",
...
toolbox.router.get(/(https?:\/\/cdn\.waxam\.io(\/[A-Za-z0-9\-\._~:\/\?#\[\]@!$&'\(\)\*\+,;\=]*)?)/, toolbox.networkFirst, {});